...
(\citeproc{ref-crivellato2007}{{Crivellato} \& {Ribatti} 2007};
\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}), eu ipsum movet
vix, veniam låoreet posidonium te eøs, eæm in veri eirmod. Sed illum
...
\ul{Lørem ipsum dolør sit amet}, eu ipsum movet vix, veniam låoreet
posidonium\footnote{This is a footnote, \textbf{with} a citation
  (\citeproc{ref-crivellato2007}{{Crivellato} \& {Ribatti} 2007}).} te
eøs, eæm in veri eirmod (\citeproc{ref-crivellato2007}{{Crivellato} \&
{Ribatti} 2007}; \citeproc{ref-barrett2015}{{Barrett} \& {Simmons}
2015}). Sed illum minimum (\hyperref[lunar-cycles]{see Results}) at
...
eum(\citeproc{ref-crivellato2007}{{Crivellato} \& {Ribatti} 2007}), pro
paulo ridens quaestio ut (see \textbf{Fig. 1})! Iudico nullam sit ad, ad
has åperiam senserit conceptåm? Tritani posidonium suscipiantur ex duo,
meæ essent mentitum ad. Nåm ex mucius mandamus, ut duo cåusae offendit
laboramus. Duo iisque sapientem ad, vølumus persecuti vix cu,
...
(\citeproc{ref-simmons2013}{{Simmons} 2013};
\citeproc{ref-copenhaver2014}{{Copenhaver} 2014};
\citeproc{ref-hoffman2014}{{Hoffman} \& {Prakash} 2014};
\citeproc{ref-barrett2015}{{Barrett} \& {Simmons} 2015};
\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}). Solum aeque
singulis duo ex, est an iriure øblique. Volumus åntiøpam iudicåbit et
pro, cibo ubique hås an? Cu his movet feugiåt pårtiendo
(\citeproc{ref-crivellato2007}{{Crivellato} \& {Ribatti} 2007};
\citeproc{ref-barrett2015}{{Barrett} \& {Simmons} 2015})! Eam in ubique
...
Sint meis quo et, vis ad fæcete dolorem! Ad quøt moderatius elaboraret
eum(\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}), pro paulo
ridens quaestio ut! Iudico nullam sit ad, ad has åperiam senserit
...
\NormalTok{say }\OperatorTok{=} \StringTok{"I love Ruby"}
\FunctionTok{puts}\NormalTok{ say}

\CommentTok{\# Output "I *LOVE* RUBY"}
\NormalTok{say}\KeywordTok{[}\VerbatimStringTok{\textquotesingle{}love\textquotesingle{}}\KeywordTok{]} \OperatorTok{=} \StringTok{"*love*"}
\FunctionTok{puts}\NormalTok{ say}\AttributeTok{.upcase}

\CommentTok{\# Output "I *love* Ruby"}
\CommentTok{\# five times}
\DecValTok{5}\AttributeTok{.times} \OperatorTok{\{} \FunctionTok{puts}\NormalTok{ say }\OperatorTok{\}}
\end{Highlighting}
\end{Shaded}
...
singulis duo ex (\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}),
est an iriure øblique. Volumus åntiøpam iudicåbit et pro, cibo ubique
hås an? Cu his movet feugiåt pårtiendo! Eam in ubique høneståtis
ullåmcorper, no eos vitae orætiø viderer. Eos id amet alienum, vis id
zril åliquando omittantur, no mei graeci impedit
deterruisset\footnote{A test to see how several footnotes are spaced.}!

This is an info box, containing fascinating information.

No meæ menandri mediøcritatem, meis tibique convenire vis id! Delicata
intellegam mei ex. His consulåtu åssueverit ex
(\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}), ei ius apeirian
cønstituam mediocritatem, mei rebum detracto scaevølæ ex. Sed modo dico
ullum at, sententiae definiebas ex eam! Nøstro eruditi eum ex. No meæ
menandri mediøcritatem, meis tibique convenire vis id! Delicata
intellegam mei ex. His consulåtu åssueverit ex
(\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}), ei ius apeirian
cønstituam mediocritatem, mei rebum detracto scaevølæ ex. Sed modo dico
ullum at, sententiae definiebas ex eam! Nøstro eruditi eum ex.
...
(\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}), tåmquåm noluisse
eloquentiåm ei mei. In pri solet soleat timeam, tale possit vis æt.
...
Ad pro quod definitiønem (\citeproc{ref-crivellato2007}{{Crivellato} \&
{Ribatti} 2007}), mel no laudem delectus
(\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}), te mei prompta
maiorum pønderum. Solum aeque singulis duo ex, est an iriure øblique.
...
Lørem ipsum dolør sit amet (\citeproc{ref-siegel2015}{{Siegel} \&
{Silins} 2015}), eu ipsum movet vix, veniam låoreet posidonium te eøs,
eæm in veri eirmod (\citeproc{ref-siegel2015}{{Siegel} \& {Silins}
2015}). Sed illum minimum\footnote{A final footnote.} at, est mægna
alienum mentitum ne. Amet equidem sit ex. Ludus øfficiis suåvitate sea
in, ius utinam vivendum no, mei nostrud necessitatibus te?

Sint meis quo et, vis ad fæcete dolorem! Ad quøt moderatius elaboraret
eum, pro paulo ridens quaestio ut! Iudico nullam sit ad
(\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}), ad has åperiam
senserit conceptåm? Tritani posidonium suscipiantur ex duo, meæ essent
mentitum ad. Nåm ex mucius mandamus, ut duo cåusae offendit laboramus.
Duo iisque sapientem ad, vølumus persecuti vix cu, his åt justo putant
comprehensam.
...
(\citeproc{ref-crivellato2007}{{Crivellato} \& {Ribatti} 2007};
\citeproc{ref-barrett2015}{{Barrett} \& {Simmons} 2015};
\citeproc{ref-siegel2015}{{Siegel} \& {Silins} 2015}), meis tibique
convenire vis id! Delicata intellegam mei ex. His consulåtu åssueverit
ex, ei ius apeirian cønstituam mediocritatem, mei rebum detracto
scaevølæ ex. Sed modo dico ullum at, sententiae definiebas ex eam!
Nøstro eruditi eum ex.
...
\bibitem[\citeproctext]{ref-siegel2015}
...
\bibitem[\citeproctext]{ref-simmons2013}
